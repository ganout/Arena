...
public class Champion {
        ...
        public void heal() {
            ...
            if ((this.life + this.intelligence) > 40) {
                ...
                this.life = 40;
                System.out.println(this.name + " s'est soigné de : " + healMini);
                System.out.println();
                System.out.println("La vie de " + this.name + " est passé a : " + this.life);
                System.out.println();
            } else {
                this.life = this.life + healValue;
                System.out.println(this.name + " s'est soigné de : " + healValue);
                System.out.println();
                System.out.println("La vie de " + this.name + " est passé a : " + this.life);
                System.out.println();
            }
        ...
        public static int elementaryEffect(Champion attackingMonster, Opponent victimMonster) {
            ...
            if (elementaryChampion.equals("fire") && elementaryVictim.equals("air")
                    || elementaryChampion.equals("air") && elementaryVictim.equals("water")
                    || elementaryChampion.equals("water") && elementaryVictim.equals("fire")) {
                damage *= 2; // damage = damage * 2;
                return damage;
            } else if (elementaryChampion.equals("water") && elementaryVictim.equals("air")
                || elementaryChampion.equals("air") && elementaryVictim.equals("fire")
                || elementaryChampion.equals("fire") && elementaryVictim.equals("water")) {
                damage /= 2; // damage = damage / 2;
                return damage;
            } else {
                return damage;
            ...
            // if (elementaryChampion.equals("fire")) {
            ...
            //         return attackingMonster.attack() * 2 ;
            //     }
            // } else if (elementaryChampion.equals("air")) {
            ...
            //         return attackingMonster.attack() * 2 ;
            //     }
            // } else if (elementaryChampion.equals("water")) {
